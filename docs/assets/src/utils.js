...
window.MUVI_I18N = {
  ar: {
    ...
    nav_picks:     "اختيارات muvi",
    nav_book:      "احجز تذكرة",
    hero_eyebrow:  "تقويم muvi السينمائي",
    ...
    stat_films:    "فيلم",
    stat_months:   "شهر",
    stat_picks:    "اختيارات muvi",
    stat_saudi:    "إنتاج سعودي",
    picks_eyebrow: "12 اختيار من muvi",
  ...
  en: {
    ...
    nav_picks:     "muvi Picks",
    nav_book:      "Book Tickets",
    hero_eyebrow:  "muvi Cinema Calendar",
    ...
    stat_films:    "films",
    stat_months:   "months",
    stat_picks:    "muvi picks",
    stat_saudi:    "Saudi productions",
    picks_eyebrow: "12 muvi Picks",
